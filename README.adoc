...
[NOTE]
====
The first creation of the cluster will take a while since all images will be pulled. Subsequent cluster creations will be faster of the volume mounts for the registry and the mirrors are not deleted.
====
